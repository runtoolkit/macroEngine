...
# were already missing in the original runtoolkit/macroEngine repo
# (1_20_5 overlay included): zprivate/split/fail, zprivate/split/last_segment, zprivate/split/main, zprivate/split/reversed/main, zprivate/split/setup, zprivate/split/split_chars/setup
# These files could not be found on disk. As it stands, this function
# will fail with a "function not found" error. The port only moved the
# namespace — it did NOT invent the missing logic.
# ============================================================================
